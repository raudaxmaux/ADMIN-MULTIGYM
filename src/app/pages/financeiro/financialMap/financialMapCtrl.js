...
(function () {
  ...
  angular.module('BlurAdmin.pages.financeiro')
      .controller('financialMapCtrl', financialMapCtrl);

  /** @ngInject */
  function financialMapCtrl(baConfig, layoutPaths) {
    ...
    var map = AmCharts.makeChart('amChartMap', {
      ...
      dataProvider: {
        ...
        zoomLatitude: -16,
        areas: [
          { title: 'Brasil', id: 'BR', color: layoutColors.primary, customData: '27.820', groupId: '1'},
